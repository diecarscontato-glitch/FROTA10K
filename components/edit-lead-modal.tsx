...
export function EditLeadModal({ lead, onOpenChange, isIcon }: { lead: any, onOpenChange?: (open: boolean) => void, isIcon?: boolean }) {
  ...
  const open = onOpenChange ? true : isOpen;
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <Card className="w-full max-w-2xl bg-slate-900 border-slate-800 shadow-2xl relative z-10 animate-in zoom-in-95 duration-200">
            <CardHeader className="relative border-b border-slate-800 pb-6">
              ...
              <CardTitle className="text-xl text-white">Editar Dados do Lead</CardTitle>
              <CardDescription className="text-slate-400">
                Corrija os dados de contato, veículo ou financeiros desta oportunidade.
              </CardDescription>
            </CardHeader>
              ...
              <CardContent className="space-y-6 pt-6 max-h-[70vh] overflow-y-auto">
                ...
                {success && (
                  <div className="p-3 rounded-md bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm">
                    Lead alterado com sucesso! Atualizando tela...
                  </div>
                )}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2 md:col-span-2">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            id="vehicle_model"
                            name="vehicle_model"
                            defaultValue={lead?.vehicle_model || ""}
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            ...
                            name="vehicle_year"
                            type="number"
                            defaultValue={lead?.vehicle_year || ""}
                            placeholder="2023"
                            className="pl-10 bg-slate-800/50 border-slate-700 text-white"
                          />
                        </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            id="vehicle_plate"
                            name="vehicle_plate"
                            defaultValue={lead?.vehicle_plate || ""}
                            placeholder="ABC1D23"
                      ...
                      <div className="space-y-4 md:col-span-2 py-2 px-3 rounded-lg bg-slate-800/30 border border-slate-800">
                        <div className="flex items-center space-x-2">
                          <Checkbox id="has_reserve_key" name="has_reserve_key" defaultChecked={!!lead?.has_reserve_key} />
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox id="has_manual" name="has_manual" defaultChecked={!!lead?.has_manual} />
                      ...
                      <div className="space-y-2 md:col-span-2">
                        ...
                        <select
                          ...
                          defaultValue={lead?.auction_history || "NÃO"}
                      ...
                      <div className="space-y-2 md:col-span-2">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            id="finance_bank"
                            name="finance_bank"
                            defaultValue={lead?.finance_bank || ""}
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            ...
                            type="number"
                            step="0.01"
                            defaultValue={lead?.finance_installment_value || ""}
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            ...
                            type="number"
                            defaultValue={lead?.finance_remaining_installments || ""}
                            placeholder="Ex: 36"
                            className="pl-10 bg-slate-800/50 border-slate-700 text-white"
                          />
                        </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            ...
                            type="number"
                            defaultValue={lead?.finance_overdue_installments || ""}
                            placeholder="Ex: 2"
                            className="pl-10 bg-slate-800/50 border-slate-700 text-white"
                          />
                        </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <Input
                            ...
                            type="number"
                            step="0.01"
                            defaultValue={lead?.owner_expectation || ""}
                         ...
                         <div className="grid grid-cols-3 gap-2">
                            {['BAIXA', 'MÉDIA', 'ALTA'].map((u) => (
                              <label key={u} className="cursor-pointer">
                                <input type="radio" name="urgency" value={u} className="hidden peer" defaultChecked={lead?.urgency ? lead.urgency === u : u === 'MÉDIA'} />
